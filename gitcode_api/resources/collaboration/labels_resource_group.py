"""AbstractLabelsResource, LabelsResource, and AsyncLabelsResource resource group."""
...
class AbstractLabelsResource(ABC):
    """Interface for Labels resource endpoints."""
...
class LabelsResource(SyncResource, AbstractLabelsResource):
...
class AsyncLabelsResource(AsyncResource, AbstractLabelsResource):
